            ...
            <tbody>
                <tr>
                    <td colspan="3" align="center" style="padding-top:32px;padding-right:32px;padding-left:32px;background:#ffffff;border-top:8px solid #01902d">
                        <img width="40" height="auto" style="display:block" alt="KPI Logo" src="{{ getenv('FE_URL') }}/assets/img/logo.png" data-image-whitelisted="" class="CToWUd">
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="3" align="center" style="padding-top:7px;padding-right:32px;padding-bottom:0px;padding-left:32px;background:#ffffff">
                        <p style="color:#323130;font-size:16px;font-weight:400;line-height:18px;margin:0;max-width:400px;padding-bottom:29px;text-align:center">{{$title}}</p>
                    </td>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td align="center" valign="top" width="640" style="background-color:#ffffff">
                                        <br/>
                                        <br/>
                                        <p style="margin:0;font-size:small">E-mail ini dibuat otomatis, mohon tidak membalas. Jika butuh bantuan, silakan <a href="{{ getenv('FE_URL') }}" style="text-decoration:none;color:#03ac0e;font-weight:bold" target="_blank" data-saferedirecturl="{{ getenv('FE_URL') }}">hubungi tim support</a>.</p>
                                        <br/>
                                    </td>
                                </tr>
